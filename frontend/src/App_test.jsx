...
export default function UnifiedBrainApp() {
  const [activeView, setActiveView] = useState('cfc'); // 'cfc', 'hub', 'chart'
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-gray-50 to-gray-100">
      <div className="flex h-screen">
        ...
        <div className="w-20 bg-gradient-to-b from-indigo-600 to-purple-700 shadow-xl flex flex-col items-center py-6 space-y-6">
          <div className="text-white text-center mb-4">
            <svg className="w-10 h-10 mx-auto mb-2" fill="none" viewBox="0 0 24 24" stroke="currentColor">
              <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9.663 17h4.673M12 3v1m6.364 1.636l-.707.707M21 12h-1M4 12H3m3.343-5.657l-.707-.707m2.828 9.9a5 5 0 117.072 0l-.548.547A3.374 3.374 0 0014 18.469V19a2 2 0 11-4 0v-.531c0-.895-.356-1.754-.988-2.386l-.548-.547z" />
            </svg>
            <p className="text-xs font-semibold">Brain Tools</p>
          </div>
          ...
          >
            ...
            <span className="text-xs mt-1 font-medium">CFC</span>
          </button>
        ...
        <div className="flex-1 flex flex-col overflow-hidden">
          ...
          <div className="flex-1 overflow-hidden">
            {(activeView === 'cfc' || activeView === 'hub') && <NetworkAnalysisView />}
